...
namespace TP3
{
	...
	public:
       ...
       */
		...
		/**
		 * \brief Obtenir une distance euclédienne.
		 * Cette fonction permet d'obtenir la distance euclédienne entre deux sommets.
		 * \pre Les sommets doivent exister.
		 * \post Retourne la distance euclédienne entre les sommets.
		 * \exception logic_error si un des sommets n'existe pas.
		 */
		float getDistanceEucledienne(const std::string& sommetUn, const std::string& sommetDeux) const;
